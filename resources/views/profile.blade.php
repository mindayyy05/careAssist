...
<body>
    ...
    <div class="profile-card">
        <div class="card-body">
            ...
            <p><strong>House Number:</strong> {{ $user->house_number }}</p>
            <p><strong>Phone Number:</strong> {{ $user->phone }}</p> <!-- Added phone number here -->
        </div>
...
<footer class="footer">
    <div class="footer-content">
        ...
        <a href="#" class="footer-icon"><svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em"
                viewBox="0 0 256 256">
                <path fill="#1877f2"
